(function (j, f, c, i, d, l, g) { /*! Jssor */
    ...
    var b = j.$Jssor$ = new function () {
        ...
        h.Wg = function (d, a) {
            if (a) d.style.clip = "rect(" + c.round(a.$Top || a.D || 0) + "px " + c.round(a.$Right) + "px " + c.round(a.$Bottom) + "px " + c.round(a.$Left || a.C || 0) + "px)";
            else if (a !== g) {
        ...
        h.zg = function (a, b) {
            var c = h.Wd(a);
            b & 1 && h.v(a, (h.$CssWidth(c) - h.$CssWidth(a)) / 2);
        ...
        function w(f, l) {
            ...
            w = function (e, c) {
                ...
                if (c.Xd)
                    if (d) yb(h.$CreateCallback(i, O, e, c));
                    else a(e, c)
            };
            h.zb = O;
            if (d) h.zb = w;
        ...
        h.jd = function (l, m, x, q, z, A, n) {
            ...
            if (a.$Clip && b.Vg() && !a.$Clip.$Top && !a.$Clip.$Left && !a.$Clip.D && !a.$Clip.C && a.$Clip.$Right == n.$OriginalWidth && a.$Clip.$Bottom == n.$OriginalHeight) a.$Clip = i;
            return a
        }
    };
    ...
    var m = function (z, C, g, M, P, J) {
        ...
        if (b.$IsBrowserSafari() && b.$BrowserVersion() < 7) r = i;
        r = r || function (a) {
    ...
    j.$JssorSlideshowRunner$ = function (k, s, q, u, z) {
            ...
            a.ae = function (c, b) {
                ...
                if (!a.Nb[f]) {
                    ...
                    for (var d = 0; d < a.$Cols; d++)
                        for (var e = 0; e < a.$Rows; e++) a.Nb[f][e + "," + d] = {
                            $Top: e * b,
                            $Right: d * c + c,
                            $Bottom: e * b + b,
                            $Left: d * c
                ...
                b.$Each(h, function (G) {
                    ...
                    if (a.$Zoom || a.$Rotate) {
                        ...
                        if (H) {
                            ...
                            f.$Zoom = 1;
                            if (b.wb() || b.$IsBrowserOpera()) e.$Zoom = c.min(e.$Zoom, 2);
                            var N = a.$Rotate || 0;
        ...
        if (b.wb() || b.$IsBrowserOpera() || z && b.$WebKitVersion() < 537) h = 16;
        n.call(f);
        m.call(f, -1e7, 1e7)
    };
    var k = j.$JssorSlider$ = function (p, hc) {
                ...
                if (d != f) {
                    if (A) {
                        ...
                        if (g) {
                            var k = R = b.O(),
                                h = C[t(d)];
                            return h.Lb(b.$CreateCallback(i, X, d, h, g, k), x)
                        }
                    }
                    ob(d)
                } else if (a.$Loop) {
            ...
            function T(a, c, e) {
                ...
                b.$Each(f, function (f) {
                    ...
                    if (i == "caption") {
                        ...
                        if (h == "A") {
                            if (b.$AttributeEx(f, "u") == "image") o = b.Jf(f, "IMG");
        ...
        function Gb(c, d) {
            ...
            b.$Each(Nb, function (a) {
                var c = b.Zb(b.$AttributeEx(a, "autocenter"));
                b.zg(a, c)
            })
        }
        ...
        if (r) {
            ...
            b.$AddEvent(p, "mouseout", b.hc(kc, p));
            b.$AddEvent(p, "mouseover", b.hc(jc, p));
            if (Y) {
        ...
        f.mc = function (E) {
            if (!u) {
                ...
                for (var f = 0; f < s; f++) {
                    ...
                    a.$ActionMode & 2 && b.$AddEvent(l, "mouseover", b.hc(b.$CreateCallback(i, t, f), l));
                    y[f] = b.Xb(l)
                }
                u = d
            }
    ...
    j.$JssorThumbnailNavigator$ = function (g, B) {
        ...
        function A(n, f) {
            ...
            g.ib = f;
            g.zd = q;
            l = n.ug || n.Ob || b.$CreateDiv();
            g.Mb = c = b.hd(j, "thumbnailtemplate", l, d);
            m = b.Xb(c);
            a.$ActionMode & 1 && b.$AddEvent(c, "click", b.$CreateCallback(i, k, 0));
            a.$ActionMode & 2 && b.$AddEvent(c, "mouseover", b.hc(b.$CreateCallback(i, k, 1), c))
        }
        h.zc = function (b, d, f) {
            var a = p;
            p = b;
    ...
    j.$JssorCaptionSlideo$ = function (v, j, u) {
        ...
        g(e, o);
        var x = j.$Breaks || [],
            k = [].concat(x[b.Zb(b.$AttributeEx(v, "b"))] || []);
        k.push({
            b: e.Db(),
            d: k.length ? 0 : u
        });
